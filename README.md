...
本项目提供了一个强大的静态分析工具 `code-context-analyzer/scripts/analyze_project.py`，支持以下特性：
...
- **`code-context-analyzer/scripts/`**: 核心工具集。
...
详细的上下文生成协议请参考 [SKILL.md](./code-context-analyzer/SKILL.md)。
